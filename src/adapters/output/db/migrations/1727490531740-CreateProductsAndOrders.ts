        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: 'buyer_accepts_marketing', type: 'boolean', isNullable: true },
                    { name: 'confirmation_number', type: 'varchar', length: '255', isNullable: true },
                    ...
                    { name: 'current_subtotal_price', type: 'decimal', precision: 10, scale: 2, isNullable: true },
                    { name: 'current_total_price', type: 'decimal', precision: 10, scale: 2, isNullable: true },
                    { name: 'current_total_tax', type: 'decimal', precision: 10, scale: 2, isNullable: true },
                    { name: 'customer_locale', type: 'varchar', length: '10', isNullable: true },
                    { name: 'financial_status', type: 'varchar', length: '255', isNullable: true },
                    { name: 'name', type: 'varchar', length: '255', isNullable: true },
                    { name: 'order_number', type: 'int', isNullable: true },
                    { name: 'presentment_currency', type: 'varchar', length: '10', isNullable: true },
                    { name: 'processed_at', type: 'timestamp', isNullable: true },
                    { name: 'source_name', type: 'varchar', length: '255', isNullable: true },
                    { name: 'subtotal_price', type: 'decimal', precision: 10, scale: 2, isNullable: true },
                    { name: 'tags', type: 'text', isNullable: true },
                    { name: 'tax_exempt', type: 'boolean', isNullable: true },
                    { name: 'total_discounts', type: 'decimal', precision: 10, scale: 2, isNullable: true },
                    { name: 'total_line_items_price', type: 'decimal', precision: 10, scale: 2, isNullable: true },
                    { name: 'total_price', type: 'decimal', precision: 10, scale: 2, isNullable: true },
                    { name: 'total_tax', type: 'decimal', precision: 10, scale: 2, isNullable: true },
                    { name: 'updated_at', type: 'timestamp', isNullable: true },
                    { name: 'user_id', type: 'bigint', isNullable: true },
                    { name: 'checkout_id', type: 'bigint', isNullable: true },
                    { name: 'checkout_token', type: 'varchar', length: '255', isNullable: true }
                ],
            }),
            true
        );
